...
***unblock_suite_ip.txt*** ==> [RAW](https://raw.githubusercontent.com/naruto522ru/resolving-public/main/unblock_suite_ip.txt) 20573413 IPs

***unblock_suite_ip_ipset.txt*** ==> [RAW](https://raw.githubusercontent.com/naruto522ru/resolving-public/main/unblock_suite_ip_ipset.txt) 21126428 IPs
...
А точнее их адреса с некоторым исключением например из подсетей CloudFlare такие адреса исключаются.

- **GitHub**

- **Российские интернет-провайдеры (Корбина,МТС,Ростелеком)**
...
- **Russian ISPs (MTS, Corbina, Rostelecom)**
